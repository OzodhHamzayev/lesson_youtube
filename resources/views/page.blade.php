                ...
                <div class="position-relative overflow-hidden">
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1" href="{{ asset('assets/img/img/portfolio-1.jpg') }}"
                ...
                <div class="position-relative overflow-hidden">
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1" href="{{ asset('assets/img/img/portfolio-2.jpg') }}"
                                data-lightbox="portfolio">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                ...
                <div class="position-relative overflow-hidden">
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1" href="{{ asset('assets/img/img/portfolio-3.jpg') }}"
                                data-lightbox="portfolio">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                ...
                <div class="position-relative overflow-hidden">
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1" href="{{ asset('assets/img/img/portfolio-4.jpg') }}"
                                data-lightbox="portfolio">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                ...
                <div class="position-relative overflow-hidden">
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1" href="{{ asset('assets/img/img/portfolio-5.jpg') }}"
                                data-lightbox="portfolio">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    ...
                    <div class="portfolio-text bg-primary">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-sm btn-secondary m-1"
                                href="{{ asset('assets/img/img/portfolio-6.jpg') }}" data-lightbox="portfolio">
                                <i class="fa fa-eye"></i>
                            </a>
                        </div>
                    </div>

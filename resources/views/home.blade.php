        ...
        <div class="row">
            ...
            <div class="col-lg-7 pt-5 pb-lg-5">
                ...
                <div class="d-flex align-items-center pt-4">
                    {{-- <a href="" class="btn btn-primary mr-5">{{ route('') }}</a> --}}
        ...
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel team-carousel position-relative">
                    ...
                    {{-- <form action="{{ route('employees.show', $employee->slug) }}" method="get"> --}}
                    <div class="team d-flex flex-column text-center rounded overflow-hidden">
                        ...
                        <div class="d-flex flex-column bg-primary text-center py-4">
                            ...
                            {{-- <p class="text-white m-0">{{ $employee->type }}</p> --}}
                            <button class="text-white m-0 btn btn-dark" type="submit">view</button>
                        </div>
                    </div>
                    </form>
                    {{-- @endforeach
